...
export default function BookmarkInteract() {
  ...
  return (
    ...
    >
      ...
      >
        <circle
          className={`transition-all duration-300 group-hover:fill-white group-hover:opacity-100 ${isBookmarked ? "fill-white opacity-1" : "fill-[#10141E]"}`}
          cx="16"
          cy="16"
          r="16"
        />
        <path
          className={`${isBookmarked ? "stroke-black" : "stroke-white"} transition-all duration-300 group-hover:stroke-black`}
