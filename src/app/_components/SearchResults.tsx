...
export default function SearchResults({moviesData}: SearchResultsProps) {
    const length = moviesData.length;
  return (
    <section className="text-white mt-[3.5rem]">
      <h2 className="text-[3.2rem] font-normal tracking-[-0.5px] leading-normal">Found {length} results for X</h2>
